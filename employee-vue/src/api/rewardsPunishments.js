...
export default {
  ...
  getRewardsPunishmentsListPage(current, limit, rewardspunishmentsQueryVo) {
    return request({
      url: `/employee/rewards_punishments/listPage/${current}/${limit}`,
      method: "post",
  ...
  getRewardsPunishments(current, limit, rewardspunishmentsQueryVo) {
    return request({
      url: `/employee/rewards_punishments/getRewardsPunishments/${current}/${limit}`,
      method: "post",
      data: rewardspunishmentsQueryVo
    })
  },
  ...
  deleteRewardsPunishmentsById(id) {
    return request({
      url: `/employee/rewards_punishments/${id}`,
      method: "delete"
    })
  },
  //3.添加
  addRewardsPunishments(rewardspunishments) {
    return request({
      url: `/employee/rewards_punishments`,
      method: "post",
  ...
  getRewardsPunishmentsList() {
    return request({
      url: `/employee/rewards_punishments/list`,
      method: "get"
    })
  },
